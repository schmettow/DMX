...
#| caption: Dmx reliability of Attractiveness, Hedonism and Credibility before and after removal of falsely favored items.
  ...
  filter(!Item %in% c("Credib1", "Credib2", "HQI5", "HQI1")) |> 
  group_by(Scale) |> 
  group_split() |> 
  map_df(alpha_ci)
