...
In the following we present a short recap on psychometric principles and workflows, from which we derive principles of proper designometric scale development, as well as the psychometric fallacy. While we believe that the theoretical argument can stand on its own, we examine the real consequences of the psychometric fallacy on data obtained from several commonly used UX rating scales.
