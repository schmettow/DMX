# The designometric perspective and the psychometric fallacies
...
#### Designometric run-time

Once validated a designometric can be used to put a single designs on a scale by either giving it a rank in the population (or what is known about it from development samples). In this case, the data formally is a psychometric response matrix, from which the researcher can derive how the design fares. In the simplest case this were a mean score, but also variance can be considered under a fairness perspective.
