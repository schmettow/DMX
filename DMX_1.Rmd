...
```{r gather_data, include = purp.gather, eval = purp.gather}
...
Past users may have scratched their heads more often than we know.
The techniques used in the comparison of perspectives are commonly applied as quick sanity checks, whenever multi-item scales are used in running studies (run time). Everyone in the past who used designometric scales and followed APA guidelines,  was likely to the psychometric fallacy and experience some unnecessary headaches. 
